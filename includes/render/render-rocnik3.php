<?php
$subjectModel = new SubjectModel('rocnik3');
$subjects = $subjectModel->getAll();

$optionalModel = new SubjectModel('rocnik3_optional');
...
$alreadyRendered = [];
$dvojiceZvyraznene = ['deskriptivní geometrie', 'hudební výchova', 'Advanced English'];
?>

<h2 class="mb-4">Výběr volitelných předmětů – 3. ročník</h2>
...
<form method="post" action="submit.php">
            ...
            <tr>
                ...
                <?php foreach ($categories as $category): ?>
                    ...
                    if (isset($row[$category])) {
                        ...
                        if ($isLinked) {
                            $color = in_array($s['name'], $dvojiceZvyraznene) ? '#d1f5ce' : '#ffe199';
    ...
    <div id="selection-count" class="mb-3 fw-bold text-danger">
        Zvoleno: 0 / 4 hodin, z toho povinně volitelných: 0
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (totalHours !== requiredHours) {
            ...
            e.preventDefault();
            alert(`Musíte vybrat alespoň ${minRequiredChoices} povinně volitelný předmět.`);
        }
    });
